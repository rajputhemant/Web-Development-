...
export const Header = () => {
  return (
    <>
      ...
      <div className="flex  justify-between  items-center p-2 bg-gray-300 text-shadow-amber-50 top-0 sticky w-380 h-20 rounded-2xl mt-0.5 opacity-95 z-100">
        <span className="mx-3 text-2xl font-bold"><h1>Welcom the Mekup Store</h1></span>
